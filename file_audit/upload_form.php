...
<form method="post" enctype="multipart/form-data" action="upload_form2.php">
<div class="container">
				<div class="row">
                 <div class="col-sm-12"><h3>อัพโหลดไฟล์ลงหัวห้อหลัก</h3><hr></div>
                </div>
                
                
                <div class="row">
                         <div class="col-xs-2"><label>หมวดที่มีอยู่</label></div>
                        <div class="col-xs-6">
                        	<select name="selMainfolder" class="form-control">
             			<option>--เลือกหมวที่มีอยู่--</option>
							 <?php
