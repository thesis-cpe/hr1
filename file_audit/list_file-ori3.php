				 ...
				 <?php }
					...
					<!--EDIT DELETE SUB-->
							<td> <?php  if($_SESSION['status'] == "ADMIN"){ ?>
								<center>
									<a class="btn btn-warning btn-xs" data-toggle="modal" data-target="#btnUpFileSub<?php echo $subID; ?>"><span class="glyphicon glyphicon-floppy-open"></a>
									<!--EDIT-->
				  ...
				  <?php }?>
				   ...
				   <?php 
					...
					<!--EDIT DELETE SUB2-->
							<td><?php  if($_SESSION['status'] == "ADMIN"){ ?>
								<center>
									<a class="btn btn-danger btn-xs" data-toggle="modal" data-target="#btnUpFileSub2<?php echo $sub2IdFromSub2; ?>"><span class="glyphicon glyphicon-floppy-open"></a>
									<!--EDIT-->
