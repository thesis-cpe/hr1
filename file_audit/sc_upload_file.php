...
$main_folder_id = $_POST['hdMainFolder'];
$sub_folder_id = $_POST['selSubfolder'];
...
if(isset($_FILES["fileThPDF"]["tmp_name"])){
		...
		if(move_uploaded_file($_FILES["fileThPDF"]["tmp_name"],"storage/".$_FILES["fileThPDF"]["name"]))
		{
			...
			$sql = "INSERT INTO file(file_id, path_file, type_file, main_id, sub_id, sub2_id) VALUES ('','$path_th_pdf',1,'$main_folder_id','$sub_folder_id',0)";
...
if(isset($_FILES["fileThOff"]["tmp_name"])){
		if(move_uploaded_file($_FILES["fileThOff"]["tmp_name"],"storage/".$_FILES["fileThOff"]["name"]))
		{
			...
			$sql_type2 = "INSERT INTO file(file_id, path_file, type_file, main_id, sub_id, sub2_id) VALUES ('','$path_th_off',2,'$main_folder_id','$sub_folder_id',0)";
...
if(isset($_FILES["fileEnPDF"]["tmp_name"])){
		if(move_uploaded_file($_FILES["fileEnPDF"]["tmp_name"],"storage/".$_FILES["fileEnPDF"]["name"]))
		{
			...
			$sql_type3 = "INSERT INTO file(file_id, path_file, type_file, main_id, sub_id, sub2_id) VALUES ('','$path_en_pdf',3,'$main_folder_id','$sub_folder_id',0)";
...
if(isset($_FILES["fileEnOff"]["tmp_name"])){
		if(move_uploaded_file($_FILES["fileEnOff"]["tmp_name"],"storage/".$_FILES["fileEnOff"]["name"]))
		{
			...
			$sql_type4 = "INSERT INTO file (file_id, path_file, type_file, main_id, sub_id, sub2_id) VALUES ('','$path_en_off',4,'$main_folder_id','$sub_folder_id',0)";
