...
<form method="post" action="up_s_lv2_3.php">
...
<div class="container">
			...
			<div class="row">
        		<div class="col-xs-2"><label>หัวข้อหลักจากหมวดที่เลือก</label></div>
        		<div class="col-xs-6">
              ...
              <div class="col-xs-3">
                    <button type="submit" name="btnUpfile" id="btnUpfile" class="btn btn-default">เลือก</button></div>
    </div><br>
