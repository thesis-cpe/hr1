...
include_once('inc/config.php');
	...
	include_once('inc/connect.php'); 
			...
			{/*ติดตรงนี้*/
				...
				{
					$sql = ("INSERT INTO audit_rc_mth (audit_rc_m_imp_dat, audit_rc_m_import_who, audit_rc_m_yt, audit_rc_m_mt, audit_rc_m_activity, audit_rc_m_complete, audit_rc_m_complete_dat, audit_rc_m_progress, audit_rc_m_problem, fk_n_customer_id) 
						VALUES ('$datein', '$employee', '$year', '$month', '$data_detail[$value]','$data_complete[$value]','$data_complete_date[$value]', '$data_pro[$value]', '$data_prob[$value]', '$cusgen')");
