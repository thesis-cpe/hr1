        ...
        foreach ($list as $rs) {
            ...
            <tr class="active">
              ...
              <!--  <td><a href="#" onclick="delete_member(<?php echo $rs['fk_employee_worker_id']; ?>,<?php echo $rs['fk_n_customer_id']; ?>);"><img src="inc/remove.png"></a></td> -->
               <td><a onclick="return confirm('ลบข้อมูล');" href="sc_delmembr.php?employee_id=<?php echo $rs['fk_employee_worker_id']; ?>&customer=<?php echo $rs['fk_n_customer_id']; ?>&id=<?php echo $rs['coast_work_id'];?>&cusnew=<?php echo $_GET['cusnew'];?>"><img src="inc/remove.png"></img></a></td> 
            </tr>
        </tbody>
            <?php
        }
