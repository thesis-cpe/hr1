                                             ...
                                             ?>
                                                    <tr>
                                                        ...
                                                        <td align="center"><?php echo $arrSelCustomerAndGen['customer_company']; ?></td>
                                                         ...
                                                         <!--ค่าจ้างทำบัญชี-->
                                                        <td align="center"><?php echo  $arrSelCustomerAndGen['customer_gen_charge']; 
                                                            $revenueInt = $revenueInt + $arrSelCustomerAndGen['customer_gen_charge'];
                                                        ?></td>
                                                      ...
                                                      ?>
                                                        ...
                                                        <td align="center"><?php echo $resultSelDrRec['drRecord']; ?></td>
