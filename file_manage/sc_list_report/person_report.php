...
if ($txtName != NULL) {
    ...
    if ($selStatus != "" && $selYear == "") {
       ...
       $selCustomer_gen_sum = "SELECT SUM(customer_gen_revenue) AS revenue, SUM(customer_gen_charge) AS charge  FROM `coast_work` JOIN customer_gen ON coast_work.fk_n_customer_id = customer_gen.n_customer_id WHERE `fk_employee_worker_id` = '$emWorkId' AND check_close = '$selStatus'";
        //$selCustomer_gen_sum = "SELECT SUM(coast_work_bath) AS revenue, SUM(customer_gen_charge) AS charge  FROM `coast_work` JOIN customer_gen ON coast_work.fk_n_customer_id = customer_gen.n_customer_id WHERE `fk_employee_worker_id` = '$emWorkId' AND check_close = '$selStatus'";
        /* ค่าแรงประมาณการ */
                                                    ...
                                                    while ($customer_gen = $queryCustomer_gen->fetch_array()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            $spendTime = "SELECT SUM(dr_time_hour) AS drSumHour, SUM(dr_time_minute) AS drSumMinute,SUM(dr_record) AS sumRec FROM daily_record WHERE dr_em_id = '$emWorkId' AND fk_n_customer_id = '$customer_gen_id'";
                                                                ...
                                                                $drTimeHourTominute = calTime($drTimeHour, $drTimeMinute);
                                                                echo $drTimeHourTominuteTohour = convMinToHourHour($drTimeHourTominute);
                                                                ?>
                                                            </td>
                                                            <td align="center"><?php
                                                                /*ผลต่างเวลา*/
                                                                   $difDrTimeUseTopViewMinute = ($sumHour*60) -  $drTimeHourTominute;
                                                                   echo $difDrTimeUseTopViewHour = convMinToHourHour($difDrTimeUseTopViewMinute);
                                                                ?>
                                                            </td>
                                                            <!--ECHO RECORD-->
                                                            <td align="center"><?php echo $sumRecord; $sumRecordAll = $sumRecordAll + $sumRecord;
                                 ...
                                 /*ส่วนนี้รอการทดสอบทางตรรกะ*/                  
                                                   ...
                                                   /*.ส่วนนี้รอการทดสอบทางตรรกะ*/      
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>&nbsp;</th>
                                                        <th align="center">ประมาณการ <?php //echo $selCustomer_gen_sum;?></th>
                                                ...
                                                <table width="1115" class="table table-striped table-hover-color">
                                                   ...
                                                   <tr>
                                                    ...
                                                    <!--    <td>สถานะ</td> -->
                                                        ...
                                                        <!--ผลต่าง--> 
                                                        <td align="center"><?php echo number_format($difTimeuseRealMinuteToHour,2) ; ?></td>
                                                         <!--record--> 
                                                        <td align="center"><?php echo $sumRecordAll;?></td>
                                                         <!--ค่าแรงประมาณการ--> 
                                                        <td align="right"><?php echo number_format($sumIntitialCoast);?></td>
                                                         <!--ค่าแรงใช้จริง--> 
                                                        <td align="right"><?php echo number_format($sumRealWage2);?></td>
                                                        <!--ค่าแรงส่วนต่าง--> 
                                                        <td align="right"><?php echo number_format($difInWage); ?></td>
                                                    </tr> 
                                                </table>
