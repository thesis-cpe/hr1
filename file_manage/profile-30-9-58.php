				                        ...
				                        <div class="row">
				                            <div class="col-md-4">
				                                <div class="form-group">
				                                    <div class="text-center mbl"><img src="<?php echo("$row[employee_picture]"); ?>" alt="" class="img-responsive img-circle"/></div>
				                            ...
				                            <div class="col-md-8">
												...
												$sqlMsn ="SELECT * FROM message JOIN employee ON message.sender = employee.employee_worker_id WHERE receiver = '$receiver' AND view='0' ORDER BY time DESC ";
												$qryMsn =  $conn->query($sqlMsn);
												$num = $qryMsn->num_rows;
												?>

													<!-- Nav tabs -->
													<ul class="nav nav-tabs" role="tablist">
														<li role="presentation" class="active"><a href="#inbox" aria-controls="inbox" role="tab" data-toggle="tab">ข้อความ&nbsp;<span class="badge"><?php echo $num; ?></span></a></li>
												   				...
												   				<div class="table-responsive">
																	<table class="table table-striped table-hover-color">
																		<tr class="danger">
														 				...
														 				<?php while($arrMsn = $qryMsn->fetch_array()){?>	
																		<tr>
																			<td><?php echo $arrMsn['time']; ?></td>
																			<td><?php echo $arrMsn['sender']."(".$arrMsn['employee_name'].")"; ?></td>
																			<td>
																				<label><font color="blue"><?php echo $arrMsn['title']; ?></font></label><br>
																				<?php echo $arrMsn['msn']; ?>
																			</td>
																			<!--ลบข้อความ-->
																			<td>
																				<a title="ตอบกลับ" class="btn btn-info btn-sm" data-toggle="modal" data-target="#btnReply<?php echo $arrMsn['id']; ?>"><span class="fa fa-mail-reply"></span></a>
																				<a title="ลบข้อความ" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#btnTrash<?php echo $arrMsn['id']; ?>"><span class="fa fa-trash-o"></span></a>
																				
																				<!--MODAL TRASH-->
																				<div class="modal fade" id="btnTrash<?php echo $arrMsn['id']; ?>">
																					<form action="sc_msn/delete_msn.php" method="post">
																			  				...
																			  				<div class="panel panel-violet">
																								<div class="modal-content">
																				  					...
																				  					<div class="modal-body">
																										<p class="text-danger">ต้องการลบข้อความจาก : <?php echo $arrMsn['sender']; ?> ส่งถึงคุณเมื่อ  <?php echo $arrMsn['time']; ?></p>
																					    				<input type="hidden" name="hdfIdMsn" value="<?php echo  $arrMsn['id'];  ?>" />
																									</div>
																				...
																				<!--MODAL REPLY-->
																				<div class="modal fade" id="btnReply<?php echo $arrMsn['id']; ?>">
																			  			...
																			  			<div class="modal-dialog">
																			  				<div class="panel panel-violet">
																								<div class="modal-content">
																			      					...
																			      					<div class="modal-body">
																			       						<div class="form-group">
																			            					<label class="control-label">ผู้รับ : <?php echo $arrMsn['employee_name']; echo "&nbsp;".$arrMsn['employee_lname']  ?></label><br>
																			            					<label class="control-label">เรื่อง : </label>
																			            					<input type="text" class="form-control" name="txtTitle" value="<?php echo "ตอบกลับ:".$arrMsn['title'];?>"/>
																			          					</div>
																			          					...
																			          					<input type="hidden" name="hdfRecive" value="<?php echo $arrMsn['employee_worker_id'];?>">
																			      					</div>
